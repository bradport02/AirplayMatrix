...
Direct PySide2 port of app/matrix_controller.py -- see that file's
docstring for the full rationale (single-slot "latest wins" mailbox,
worker-thread encode, USB auto-detect/reconnect). Only the import line
differs; matrix/link.py and encoder.py have no Qt dependency.
"""
